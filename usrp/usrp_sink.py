...
class usrp_sink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_sink")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, var_frequency, 1, 0, 0)
    ...
    def set_var_frequency(self, var_frequency):
        ...
        self.analog_sig_source_x_0.set_frequency(self.var_frequency)
